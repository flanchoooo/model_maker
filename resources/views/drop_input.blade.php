        ...
        <div class="col-md-6 col-lg-offset-3">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Delete Company Inputs</h3>
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="drop_input/destroy{id}" method="POST">
                    @csrf
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <textarea type="text" class="form-control"  placeholder="Company Name" id="textarea"  name="description"  value="{{$record->revenue}}" required readonly>{{$record->revenue}}</textarea>
                        </div>
                    </div>
                    @endforeach
                    <!-- /.box-body -->
